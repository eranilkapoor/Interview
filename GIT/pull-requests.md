...
Pull Requests belongs to the GIT skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how Pull Requests connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for Pull Requests
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is Pull Requests in the context of GIT?**  
...
**Q: When would you use Pull Requests in a production project?**  
...
**Q: What should you compare Pull Requests with?**  
...
**Q: How would you debug an issue related to Pull Requests?**  
