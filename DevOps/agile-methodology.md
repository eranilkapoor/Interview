...
Agile Methodology belongs to the DevOps skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how Agile Methodology connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for Agile Methodology
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is Agile Methodology in the context of DevOps?**  
...
**Q: When would you use Agile Methodology in a production project?**  
...
**Q: What should you compare Agile Methodology with?**  
...
**Q: How would you debug an issue related to Agile Methodology?**  
