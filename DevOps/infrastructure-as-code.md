...
Infrastructure As Code belongs to the DevOps skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how Infrastructure As Code connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for Infrastructure As Code
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is Infrastructure As Code in the context of DevOps?**  
...
**Q: When would you use Infrastructure As Code in a production project?**  
...
**Q: What should you compare Infrastructure As Code with?**  
...
**Q: How would you debug an issue related to Infrastructure As Code?**  
