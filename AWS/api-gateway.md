...
API Gateway belongs to the AWS skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how API Gateway connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for API Gateway
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: When would you use API Gateway in a production project?**  
...
**Q: What should you compare API Gateway with?**  
...
**Q: How would you debug an issue related to API Gateway?**  
