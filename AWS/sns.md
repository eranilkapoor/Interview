...
SNS belongs to the AWS skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how SNS connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for SNS
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is SNS in the context of AWS?**  
...
**Q: When would you use SNS in a production project?**  
...
**Q: What should you compare SNS with?**  
...
**Q: How would you debug an issue related to SNS?**  
