...
Jenkinsfile belongs to the Jenkins skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
This example highlights how Jenkinsfile connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for Jenkinsfile
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is Jenkinsfile in the context of Jenkins?**  
...
**Q: When would you use Jenkinsfile in a production project?**  
...
**Q: What should you compare Jenkinsfile with?**  
...
**Q: How would you debug an issue related to Jenkinsfile?**  
