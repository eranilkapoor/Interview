...
HTTP belongs to the Node skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
createServer((req, res) => res.end('HTTP')).listen(3000);
~~~
...
This example highlights how HTTP connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for HTTP
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is HTTP in the context of Node?**  
...
**Q: When would you use HTTP in a production project?**  
...
**Q: What should you compare HTTP with?**  
...
**Q: How would you debug an issue related to HTTP?**  
