...
Unit Tests belongs to the Node skill set. In interviews, it is useful because it shows whether you can connect theory with the way real systems are built, tested, deployed, and maintained.
...
createServer((req, res) => res.end('Unit Tests')).listen(3000);
~~~
...
This example highlights how Unit Tests connects to real project decisions: configuration, safety, performance, or maintainability.

~~~bash
# Interview checklist for Unit Tests
echo "Problem solved"
echo "Main mechanism"
echo "Tradeoffs"
...
**Q: What is Unit Tests in the context of Node?**  
...
**Q: When would you use Unit Tests in a production project?**  
...
**Q: What should you compare Unit Tests with?**  
...
**Q: How would you debug an issue related to Unit Tests?**  
